...
The runnable JavaFX desktop application can create or open localization
projects, edit and validate translations, save work, and publish pristine and
translated clones.
...
The versioned localization-project workflow connects extraction, human editing,
validation, reinjection, and patch publication. See [ROADMAP.md](ROADMAP.md).
...
# Edit translatedText values, then validate and publish:
...
publishing a pristine source backup and translated clone. It never writes
beneath the source mod; enable the translated clone instead of the original.
